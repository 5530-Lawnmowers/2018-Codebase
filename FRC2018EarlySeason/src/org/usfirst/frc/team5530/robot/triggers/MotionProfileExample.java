...
public class MotionProfileExample {
	 ...
	 */
	public MotionProfileExample(WPI_TalonSRX talon, double[][] profile) {
		_talon = talon;
		_profile = profile;
		/*
	...
	public void reset() {
		 ...
		 */
		_bStart = false;
		System.out.println("EEEEEEEEEEEEEEEEENNNNNNNNNNNNNNNNNNNNNDDDDDDDDDDDDDDDDDDDDDDDD");
	}
	...
	public void control() {
		...
		instrumentation.process(_status, _talon);
	}
