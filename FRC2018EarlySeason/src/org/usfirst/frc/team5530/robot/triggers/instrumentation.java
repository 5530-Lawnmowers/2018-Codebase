package org.usfirst.frc.team5530.robot.triggers;
...
public class instrumentation {
	...
	public static void process(MotionProfileStatus status1, WPI_TalonSRX talon) {
		...
		if((now-timeout) > 0.2){
			...
			System.out.format("%-9s\t", ("1"));
			System.out.format("%-9s\t", round(talon.getActiveTrajectoryPosition()));
			System.out.format("%-9s\t", round(talon.getActiveTrajectoryVelocity()));
