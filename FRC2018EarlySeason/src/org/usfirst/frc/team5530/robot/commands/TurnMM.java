...
public class TurnMM extends Command{
	...
	double counter;
	int error = 7;
	public TurnMM(double radius, double arcLength, double speed, double accelerationTime, String direction) { // speed is in radians per s.True is left, false is right
		super("TurnMM");
